"""
Django settings for ant_to_rent_42941 project.
...
ROOT_URLCONF = 'ant_to_rent_42941.urls'
...
WSGI_APPLICATION = 'ant_to_rent_42941.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ant_to_rent_42941 API",
    "DESCRIPTION": "API documentation for ant_to_rent_42941 App",
    "VERSION": "v1",
}
